...
![A schematic showing where Email Security security is in the life cycle of an email received](src/assets/email-security/Cisco_to_Email_Security_MX_Inline.png)
