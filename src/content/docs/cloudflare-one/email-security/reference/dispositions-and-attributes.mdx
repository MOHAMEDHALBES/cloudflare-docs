...
| `BEC`                                   | Indicates that email address was contained in your [impersonation registry](/email-security/detection-settings/impersonation-registry/) list. Associated with `MALICIOUS` or `SPOOF` dispositions. |
